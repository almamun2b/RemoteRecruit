    ...
    <div className="mt-37 grid min-h-152.5 w-full grid-cols-1 bg-[url('/images/getStarted.webp')] bg-cover bg-center lg:grid-cols-2">
      ...
      >
        <motion.div
          ...
          className="mr-auto rounded-tr-[40px] bg-white pt-3 pr-4 shadow-[15.18px_44.45px_108.41px_0px_#3159D31F]"
        >
          <img
      ...
      <motion.div
        ...
        className="flex flex-col justify-center pl-17.5"
      >
        <motion.span
        ...
        <motion.h3
          ...
          className="mt-2.5 max-w-97.5 text-[44px] leading-14.25 font-semibold text-[#11142D]"
        >
          {data.title}
        </motion.h3>
        ...
        <motion.p
          ...
          className="mt-6 max-w-82.5 text-lg leading-8.25 text-[#767784]"
        >
          {data.description}
        </motion.p>
